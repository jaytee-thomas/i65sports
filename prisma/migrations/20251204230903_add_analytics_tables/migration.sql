...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "views_takeId_createdAt_idx" ON "views"("takeId", "createdAt");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "views_userId_idx" ON "views"("userId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "daily_analytics_takeId_date_key" ON "daily_analytics"("takeId", "date");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "daily_analytics_takeId_idx" ON "daily_analytics"("takeId");
